...
export function CatalogPage({ search, onOpenProduct }: { search: string; onOpenProduct: (id: string) => void }) {
  ...
  return <section className="mx-auto max-w-6xl px-6 py-10">
    <div className="mb-8"><p className="text-xs font-semibold uppercase tracking-[0.2em] text-amber-700">Colección 2026</p><h1 className="text-4xl font-bold text-slate-950">Camisetas con historia</h1><p className="mt-2 max-w-xl text-slate-600">Encuentra tu próxima casaca de fútbol, desde clásicos hasta los equipos y selecciones actuales.</p></div>
